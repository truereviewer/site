  ...
  <SectionComponent class="flex flex-col items-start justify-center">
    ...
    <template #content>
      ...
      <div class="flex items-start gap-4 flex-wrap lg:flex-nowrap">
        <picture class="border border-[var(--secondary-border-color)] rounded p-4 lg:w-[35%]">
        ...
        <img
          class="lg:w-[65%] object-cover border border-[var(--secondary-border-color)] rounded !mt-0"
          src="/src/assets/img/reviewer/review_modal.png"
          alt="Media gallery modal"
        />
      </div>
    </template>
  </SectionComponent>
