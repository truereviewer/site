...
<template>
  <SectionComponent id="sponserware" class="text-center mt-12" data-aos="fade-up">
    <template #content>
      ...
      <div class="flex flex-wrap items-center lg:flex-row justify-center gap-8 w-full">
        <div
          class="p-4 shadow border rounded w-[25rem] bg-gradient-to-r from-green-300/10 to-green-400"
        >
          <div class="flex justify-between items-center">
            <h3 class="!my-0 !text-black">Forever</h3>
            <span class="font-bold text-2xl">$350</span>
          </div>
          <ul class="max-w-md text-black list-inside dark:text-gray-400 !pl-0">
        ...
        <div
          class="p-4 shadow roundd border w-[25rem] bg-gradient-to-r from-green-300/10 to-green-400"
        >
          <div class="flex justify-between items-center">
            <h3 class="!my-0 !text-black">Monthly</h3>
            <span class="font-bold text-2xl">$15</span>
          </div>
          <ul class="max-w-md !text-black list-inside !pl-0">
            <li class="flex items-center !pl-0">
              <svg
                class="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0"
                aria-hidden="true"
